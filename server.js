...
app.use((req, res, next) => {
    ...
    else if (req.get('Host') === 'i.frodo.fun' || req.get('Host') === 'invite.frodo.fun') res.redirect('https://discord.com/api/oauth2/authorize?client_id=734746193082581084&permissions=268691536&scope=bot%20applications.commands');
    else if (req.get('Host') === 'slash.frodo.fun') req.redirect('https://discord.com/api/oauth2/authorize?client_id=734746193082581084&scope=applications.commands');
    else next();
});
